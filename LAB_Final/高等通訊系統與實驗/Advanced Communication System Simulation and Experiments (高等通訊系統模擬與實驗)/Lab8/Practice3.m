...
% Filter
M = La;%*Ld;
filter_analog = filter(IIR_DMA,upsample_analog);
delay = 10;
filter_analog = filter_analog(delay+1:end);
...
% Filter
M = La;%*Ld;
received_filter_analog = filter(IIR_DMA,received_signal);
delay = 10;
received_filter_analog = received_filter_analog(delay+1:end);
