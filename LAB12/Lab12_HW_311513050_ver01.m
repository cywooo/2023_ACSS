...
% Gussian filter ---------
fd = 0.15 * symbol_rate; %150e3; %0.15 * symbol_rate;
...
for j=[1:16]
    ...
    stem([1:signal_length],(s_15_reDig_),"bo");
    hold on;
    ...
    BER(j) = sum(abs(s_16_compare-s_1_compare))/2/(signal_length-20);
end
...
figure;
stem([1:signal_length],(s_15_reDig),"bo");
hold on;
stem([1:signal_length],s_1,"r+");
hold off;
legend("re","tr");
